                    ...
                    <div className="flex flex-col gap-4">
                        <div className="bg-slate-50 border-2 border-primary/60 p-2 pl-6 rounded-3xl flex flex-col sm:flex-row items-center gap-4 shadow-2xl shadow-primary/10 transition-all focus-within:ring-4 focus-within:ring-primary/5">
                            ...
                            <div className="flex w-full sm:w-auto gap-2">
                                <Link
                                    to="/app"
                                    className="bg-primary text-white px-8 py-4 rounded-2xl font-black text-sm uppercase transition-all hover:opacity-90 active:scale-95 shadow-lg shadow-primary/25"
                                >
                                    {content.hero.search.primaryCta}
                                </Link>
                                <Link
                                    to="/app"
                                    className="border-2 border-primary text-primary px-6 py-4 rounded-2xl font-black text-sm uppercase transition-all hover:bg-white/50 active:scale-95 whitespace-nowrap flex items-center justify-center"
                                >
